...
public class SettingsController {
    ...
    public String settingsUpdate(HttpServletRequest request) throws ClassNotFoundException, SQLException {
        ...
        if (username.equals(user.getUsername())) {
            ...
            return "redirect:/admin/settings?update=success";
            ...
            return "redirect:/admin/settings?update=false&message=Username already exists. Please choose another username.";
        }
